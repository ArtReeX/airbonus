...
<div class="container-fluid h-100 m-0 p-0">
    ...
    <div class="wrapper container-fluid m-0 p-0 bg-content">
        ...
        <div class="row justify-content-center p-2">
            ...
            <div class="col-12 col-md-8 col-lg-6 text-center">
                ...
                <div class="form-group">       
                    <select class="form-control hidden" id="incomes-list"> </select>
                </div>
        ...
        <div class="row justify-content-center p-2 hidden" id="airports-info_warning_block">
            <div class="col-12 col-md-8 col-lg-6 alert alert-warning text-center none" role="alert" id="incomes-info_warning"></div>
        </div>

        <div class="row justify-content-center p-2 hidden" id="airports-info_danger_block">
            <div class="col-12 col-md-8 col-lg-6 alert alert-danger text-center none" role="alert" id="incomes-info_danger"></div>
        </div>
            ...
            <div class="col-12 col-md-8 col-lg-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center m-auto text-center">
                        ...
                        <button class="col-5 col-md-3 col-lg-2 btn text-white" id="incomes-button_goto_back" ><b> BACK </b></button>
                        
                        <button class="col-5 col-md-3 col-lg-2 ml-auto btn text-white" id="incomes-button_goto_next" ><b> NEXT </b></button>
