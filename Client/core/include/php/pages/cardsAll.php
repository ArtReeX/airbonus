    ...
    <div class="wrapper container-fluid m-0 p-0 bg-content">
        ...
        <div class="row justify-content-center p-4">
            ...
            <div class="col-12 col-md-8 col-lg-6 lead text-center text-white">
                <h3> Do you currently have any of these cards? </h3>
            </div>
        ...
        <div class="row justify-content-center p-1">
            ...
            <div class="col-12 col-md-10 m-0 p-0">
                ...
                <div class="container-fluid">
                    <div class="row justify-content-beetwen" id="cardsAll-table"></div>
                </div>
        ...
        <div class="row justify-content-center p-2 hidden" id="airports-info_warning_block">
            <div class="col-12 col-md-8 col-lg-6 alert alert-warning text-center none" role="alert" id="cardsAll-info_warning"></div>
        </div>

        <div class="row justify-content-center p-2 hidden" id="airports-info_danger_block">
            <div class="col-12 col-md-8 col-lg-6 alert alert-danger text-center none" role="alert" id="cardsAll-info_danger"></div>
        </div>
