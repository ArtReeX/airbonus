...
$(document).ready(function () {
    ...
    window.socket.on("resultGetAirportsFrom", function (result) {
    ...
    window.socket.on("resultGetAirportsTo", function (result) {
    ...
    window.socket.on("resultSetAirports", function (result) {
