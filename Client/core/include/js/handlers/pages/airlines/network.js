        ...
        if (window.identifier === "airlines") {
            ...
            if (result.data.airlines.length) {
                result.data.airlines.forEach(airline => {
                    $("#airlines-list_companies").append(
                        "<li class='list-group-item' style='background-color: #4e8398;'>" +
                            String(airline.name) +
                            "</li>"
                    );
                });
                ...
                $("#airlines-list_count").text(
                    "Total of " + result.data.airlines.length + " companies"
                );
                ...
                $("#airlines-subhead p").text(
                    "We have not found airlines connecting the airports you chose."
                );
            }
        }
    });
