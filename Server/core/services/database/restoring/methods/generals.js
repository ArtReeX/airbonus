...
module.exports = function (database, async, callback) {
    ...
    async.series([
        ...
        function (done) {
            ...
            methods_module.test_table.check(database, function (error, result_exist) {
                ...
                if (error) { done(error); } else {
                    ...
                    if (result_exist) { done(); } else {
                        ...
                        // создание таблицы
                        methods_module.test_table.create(database, function (error) {

                            if (error) { done(error); } else {
                                
                                // восстановление данных таблицы
                                methods_module.test_table.fill(database, function (error) {
