                ...
                if (error) {
                    ...
                    io_serv.sockets.on('connection', function (socket) {
                        ...
                        socket.on('getAirportsFrom', function (message) {
                            ...
                            functions_module.getAirportsByLine(mysql_client, message.line, function (airports) {
                        ...
                        socket.on('getAirlines', function (message) {
                            ...
                            functions_module.getAirlines(mysql_client, socket.session.userAirportFrom, socket.session.userAirportTo, function (airlines) {
                        ...
                        socket.on('getCreditScore', function (message) {
                            ...
                            functions_module.getCreditScore(mysql_client, function (credit_score) {
                        ...
                        socket.on('setCreditScore', function (message) {
                            ...
                            functions_module.getCreditScoreById(mysql_client, message.params.creditScore, function (credit_score) {
                                ...
                                functions_module.getMinCreditScore(mysql_client, function (min_credit_score) {
                        ...
                        socket.on('getIncome', function (message) {
                            ...
                            functions_module.getIncome(mysql_client, function (income) {
                        ...
                        socket.on('setIncome', function (message) {
                            ...
                            functions_module.getIncomeById(mysql_client, message.params.income, function (income) {
                                ...
                                functions_module.getMinIncome(mysql_client, function (min_income) {
                        ...
                        socket.on('getMaritalStatus', function (message) {
                            ...
                            functions_module.getMaritalStatus(mysql_client, function (marital_status) {
                        ...
                        socket.on('getAllCards', function (message) {
                            ...
                            functions_module.getAllCards(mysql_client, function (cards) {
                        ...
                        socket.on('getAmExCards', function (message) {
                            ...
                            functions_module.getAmExCards(mysql_client, function (cards) {
                        ...
                        socket.on('getCalculatedData', function (message) {
                            ...
                            functions_module.getCalculatedData(mysql_client, socket.session, function (data) {
