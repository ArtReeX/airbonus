...
async_module.series(
    [
        ...
        function(done) {
            ...
            database_module.create(config_module.database, log, function(
                error,
                database_client
            ) {
                if (error) {
        ...
        function(done) {
            ...
            service_module.database.restoring(database, async_module, function(
                error
            ) {
                if (error) {
                    done(error);
        ...
        function(done) {
            ...
            express_module.create(config_module.server, function(
                error,
                app_server
            ) {
                if (error) {
        ...
        function(done) {
            ...
            websocket_module.create(config_module.websocket, app, function(
                error,
                websocket_server
            ) {
                if (error) {
